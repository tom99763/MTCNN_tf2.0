...
rnet_weights='../../train/Weights/rnet_weights_file/rnet_weights'

save_dir = "48"

model=MTCNN(pnet_path=pnet_weights,rnet_path=rnet_weights)
...
for annotation in annotations:
    ...
    pre_bboxes = model.r_step(image,pre_bboxes)
